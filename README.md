...
Создаём и подготавливаем ВМ [`bastion-vm`]([Building_virtual_machines.md](https://github.com/S1mu0us/Graduate-Work/blob/main/Building_virtual_machines.md?plain=1#L1-L11)) <sub>Ранее: graduate-work-vm</sub> , она будет играть роль бастиона. 
