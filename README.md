...
* Входящий трафик:
  - `TCP` `22` `CIDR` `0.0.0.0/0`
  - `TCP` `10051` `Группа безопасности` `web-sg`
  - `TCP` `10051` `Группа безопасности` `elasticsearch-sg`
* Исходящий трафик:
  - `Any` `0-65535` `Группа безопасности` `0.0.0.0/0`
